			...
			switch(select) {
				...
				case 2:
			        ...
			        while (loginAttempts < maxLoginAttempts) {
			            ...
			            String password2 = glist.get(gListIndex).getPassword();

			            if (loginId.equals(id2) && loginPw.equals(password2)) {
