...
public class ArrayDemo01 {
	...
	public static void main(String[] args) {
		...
		// 1. 배열 만들기
		int[] ar1; // 참조변수 만들기
		ar1 = new int[10]; // 인스턴스 만들기 + 인스턴스 주조를 ar1 참조변수에 저장
		
		int[] ar1_1 = new int[10]; // 참조변수 만들기 + 인스턴스 만들기 + 인스턴스 주소를 ar1_1 참조변수에 저장
		
		// 2. 배열 사용 ( 배열 요소 사용 )  - 주로 반복문과 함꼐 사용
		ar1[0] = 10; // ar1 배열이 0번째 요소에 10 저장
		...
		int[][] ar4 = new int[5][7]; // 앞에 있는게 위에 있는 배열.
		for (int i = 0; i < 5; i++) {
			for (int j = 0; j < 7; j++) {
...
// 배열 안에 배열을 넣는것도 가능(단, 같은 배열만 가능)
// 대부분 2차원( 배열 안에 배열 넣기 ) 까지만 하는게 대부분
// 객체외 배열은 참조배열