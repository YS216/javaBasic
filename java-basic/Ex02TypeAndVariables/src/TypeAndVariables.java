...
public class TypeAndVariables {
	...
	public static void main(String[] args) {
		...
		// 3. 문자열 자료형 (String, primitive type은 아님.)
		String str = "안녕하세요!!!";
		System.out.println(str);
		String str2 = "첫번째 행 (줄바꿈) 두번쨰 행 (줄바꿈) 탭 이후의 내용(backspace)다시 처음으로";
		String str3 = "첫번째 행 \n 두번쨰 행 \t 탭 이후의 내용 다시 \"처음\"으로";		
		...
		double d3 = 12.34;
		int i3 = (int)d3; // 형변환 d3의 값이 double -> int : 명시적 형변환 (데이터의 손실의 개연성이 있으면 명시적형변환)
