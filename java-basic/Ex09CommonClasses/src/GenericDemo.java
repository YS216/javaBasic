...
class TheObject {
	Object v; // 정수, 실수, 문자열, 날짜 뜽 모든 자료형의 데이터 저장
}

class TheGeneric<T, E> {
	T v1; // 아직 구체적으로 결정되지 않은 자료형 T 타입의 변수 : 사용할 떄 결정하도록 유예
	E v2;
	void m(T t) {
...
public class GenericDemo {
	...
	public static void main(String[] args) {
		...
		Date d = (Date)obj.v; // Object에 저장된 변수는 읽을 떄 반드시 형변환 필요
		...
		String s2 = tg1.v1; // 읽을 때 형변환 필요하지 않음.
		Date d2 = tg2.v1;
